...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model", default="yolov8n.pt", help="Ultralytics pretrained checkpoint or local path")
    ...
    parser.add_argument("--name", default="yolov8n_4class_finetune")
